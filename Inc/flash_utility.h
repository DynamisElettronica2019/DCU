...
#define DATA_ARE_CALIBRATED_SECTOR_ADDRESS_OFFSET		(uint32_t)0
#define APPS_FULL_SECTOR_ADDRESS_OFFSET 						(uint32_t)2
#define APPS_ZERO_SECTOR_ADDRESS_OFFSET 						(uint32_t)4
#define LINEAR_FL_SECTOR_ADDRESS_OFFSET 						(uint32_t)6
#define LINEAR_FR_SECTOR_ADDRESS_OFFSET 						(uint32_t)8
#define LINEAR_RL_SECTOR_ADDRESS_OFFSET 						(uint32_t)10
#define LINEAR_RR_SECTOR_ADDRESS_OFFSET 						(uint32_t)12
#define LOAD_CELL_FL_SECTOR_ADDRESS_OFFSET 					(uint32_t)14
#define LOAD_CELL_FR_SECTOR_ADDRESS_OFFSET 					(uint32_t)16
#define LOAD_CELL_RL_SECTOR_ADDRESS_OFFSET 					(uint32_t)18
#define LOAD_CELL_RR_SECTOR_ADDRESS_OFFSET 					(uint32_t)20
