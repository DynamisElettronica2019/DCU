...
#define BUFFER_BLOCK_LEN 																			(uint16_t)645
...
#define LOAD_CELL_FR_CSV_INDEX 																(uint16_t)165
#define BPS_FRONT_CSV_INDEX 																	(uint16_t)171
#define APPS_CSV_INDEX 																				(uint16_t)177
#define LINEARE_FL_CSV_INDEX																	(uint16_t)181
#define LOAD_CELL_FL_CSV_INDEX 																(uint16_t)188
#define BPS_REAR_CSV_INDEX 																		(uint16_t)194
#define STEERING_WHEEL_ANGLE_CSV_INDEX 												(uint16_t)200
#define LINEARE_RL_CSV_INDEX 																	(uint16_t)207
#define LOAD_CELL_RL_CSV_INDEX 																(uint16_t)214
#define LINEARE_RR_CSV_INDEX 																	(uint16_t)220
#define LOAD_CELL_RR_CSV_INDEX 																(uint16_t)227
#define IR1_FL_CSV_INDEX 																			(uint16_t)233
#define IR2_FL_CSV_INDEX 																			(uint16_t)237
#define IR3_FL_CSV_INDEX 																			(uint16_t)241
#define BRAKE_IR_FL_CSV_INDEX 																(uint16_t)245
#define IR1_FR_CSV_INDEX 																			(uint16_t)249
#define IR2_FR_CSV_INDEX 																			(uint16_t)253
#define IR3_FR_CSV_INDEX 																			(uint16_t)257
#define BRAKE_IR_FR_CSV_INDEX																	(uint16_t)261
#define IR1_RL_CSV_INDEX 																			(uint16_t)265
#define IR2_RL_CSV_INDEX 																			(uint16_t)269
#define IR3_RL_CSV_INDEX 																			(uint16_t)273
#define BRAKE_IR_RL_CSV_INDEX 																(uint16_t)277
#define IR1_RR_CSV_INDEX 																			(uint16_t)281
#define IR2_RR_CSV_INDEX 																			(uint16_t)285
#define IR3_RR_CSV_INDEX 																			(uint16_t)289
#define BRAKE_IR_RR_CSV_INDEX 																(uint16_t)293
#define IMU1_ACC_X_CSV_INDEX 																	(uint16_t)297
#define IMU1_ACC_Y_CSV_INDEX 																	(uint16_t)305
#define IMU1_GYR_X_CSV_INDEX 																	(uint16_t)313
#define IMU1_GYR_Z_CSV_INDEX 																	(uint16_t)320
#define IMU1_HEADING_CSV_INDEX 																(uint16_t)327
#define IMU1_ACC_Z_CSV_INDEX 																	(uint16_t)335
#define IMU1_GYR_Y_CSV_INDEX 																	(uint16_t)343
#define IMU1_SENSORS_CALIBRATION_CSV_INDEX										(uint16_t)350
#define IMU2_ACC_X_CSV_INDEX 																	(uint16_t)354
#define IMU2_ACC_Y_CSV_INDEX 																	(uint16_t)362
#define IMU2_GYR_X_CSV_INDEX 																	(uint16_t)370
#define IMU2_GYR_Z_CSV_INDEX 																	(uint16_t)377
#define IMU2_HEADING_CSV_INDEX 																(uint16_t)384
#define IMU2_ACC_Z_CSV_INDEX 																	(uint16_t)392
#define IMU2_GYR_Y_CSV_INDEX 																	(uint16_t)400
#define IMU2_SENSORS_CALIBRATION_CSV_INDEX 										(uint16_t)407
#define IMU_DCU_HEADING_CSV_INDEX 														(uint16_t)411
#define IMU_DCU_ACC_Z_CSV_INDEX 															(uint16_t)419
#define IMU_DCU_GYR_Y_CSV_INDEX 															(uint16_t)427
#define IMU_DCU_ACC_X_CSV_INDEX 															(uint16_t)434
#define IMU_DCU_ACC_Y_CSV_INDEX 															(uint16_t)442
#define IMU_DCU_GYR_X_CSV_INDEX 															(uint16_t)450
#define IMU_DCU_GYR_Z_CSV_INDEX 															(uint16_t)457
#define IMU_DCU_SENSORS_CALIBRATION_CSV_INDEX									(uint16_t)464
#define GPS_LATITUDE_MINUTES_CSV_INDEX												(uint16_t)468
#define GPS_LONGITUDE_MINUTES_CSV_INDEX 											(uint16_t)474
#define GPS_SPEED_CSV_INDEX	 																	(uint16_t)480
#define CLUTCH_FEEDBACK_CSV_INDEX															(uint16_t)488
#define MODE_FEEDBACK_CSV_INDEX 															(uint16_t)492
#define MAP_FEEDBACK_CSV_INDEX 																(uint16_t)494
#define ANTISTALL_FEEDBACK_CSV_INDEX 													(uint16_t)496
#define TRACTION_FEEDBACK_CSV_INDEX 													(uint16_t)498
#define RPM_LIMITER_FEEDBACK_CSV_INDEX 												(uint16_t)500
#define AUTOGEARSHIFT_FEEDBACK_CSV_INDEX 											(uint16_t)504
#define ACCELERATION_FEEDBACK_CSV_INDEX	 											(uint16_t)506
#define LAP_FLAG_CSV_INDEX																		(uint16_t)508
#define DAU_FR_TEMP_CSV_INDEX 																(uint16_t)510
#define DAU_FR_CURRENT_CSV_INDEX 															(uint16_t)513
#define DAU_FL_TEMP_CSV_INDEX 																(uint16_t)517
#define DAU_FL_CURRENT_CSV_INDEX 															(uint16_t)520
#define DAU_REAR_TEMP_CSV_INDEX 															(uint16_t)524
#define DAU_REAR_CURRENT_CSV_INDEX 														(uint16_t)527
#define SW_TEMP_CSV_INDEX 																		(uint16_t)531
#define SW_CURRENT_CSV_INDEX 																	(uint16_t)534
#define GCU_TEMP_CSV_INDEX 																		(uint16_t)539
#define GCU_CURR_CSV_INDEX 																		(uint16_t)542
#define H2O_PUMP_CURRENT_CSV_INDEX 														(uint16_t)546
#define FUEL_PUMP_CURRENT_CSV_INDEX 													(uint16_t)551
#define GEARMOTOR_CURRENT_CSV_INDEX 													(uint16_t)556
#define CLUTCH_CURRENT_CSV_INDEX 															(uint16_t)561
#define FAN_SX_CURRENT_CSV_INDEX 															(uint16_t)566
#define FAN_DX_CURRENT_CSV_INDEX 															(uint16_t)571
#define DCU_TEMP_CSV_INDEX 																		(uint16_t)576
#define DCU_CURRENT_CSV_INDEX 																(uint16_t)579
#define XBEE_CURRENT_CSV_INDEX 																(uint16_t)584
#define DUC_3V3_CURRENT_CSV_INDEX 														(uint16_t)588
#define DCU_12V_VOLTAGE_CSV_INDEX 														(uint16_t)592
#define DCU_5V_VOLTAGE_CSV_INDEX 															(uint16_t)598
#define DCU_3V3_VOLTAGE_CSV_INDEX 														(uint16_t)603
#define DATRON_DISTANCE_CSV_INDEX 														(uint16_t)608
#define DATRON_X_CSV_INDEX 																		(uint16_t)620
#define DATRON_Y_CSV_INDEX 																		(uint16_t)628
#define DATRON_ANGLE_CSV_INDEX 																(uint16_t)636
#define END_CSV_INDEX 																				(uint16_t)644
