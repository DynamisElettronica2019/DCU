...
#define BUFFER_BLOCK_LEN 																			(uint16_t)643
...
#define AUTOGEARSHIFT_FEEDBACK_CSV_INDEX 											(uint16_t)502
#define ACCELERATION_FEEDBACK_CSV_INDEX	 											(uint16_t)504
#define LAP_FLAG_CSV_INDEX																		(uint16_t)506
#define DAU_FR_TEMP_CSV_INDEX 																(uint16_t)508
#define DAU_FR_CURRENT_CSV_INDEX 															(uint16_t)511
#define DAU_FL_TEMP_CSV_INDEX 																(uint16_t)515
#define DAU_FL_CURRENT_CSV_INDEX 															(uint16_t)518
#define DAU_REAR_TEMP_CSV_INDEX 															(uint16_t)522
#define DAU_REAR_CURRENT_CSV_INDEX 														(uint16_t)525
#define SW_TEMP_CSV_INDEX 																		(uint16_t)529
#define SW_CURRENT_CSV_INDEX 																	(uint16_t)532
#define GCU_TEMP_CSV_INDEX 																		(uint16_t)537
#define GCU_CURR_CSV_INDEX 																		(uint16_t)540
#define H2O_PUMP_CURRENT_CSV_INDEX 														(uint16_t)544
#define FUEL_PUMP_CURRENT_CSV_INDEX 													(uint16_t)549
#define GEARMOTOR_CURRENT_CSV_INDEX 													(uint16_t)554
#define CLUTCH_CURRENT_CSV_INDEX 															(uint16_t)559
#define FAN_SX_CURRENT_CSV_INDEX 															(uint16_t)564
#define FAN_DX_CURRENT_CSV_INDEX 															(uint16_t)569
#define DCU_TEMP_CSV_INDEX 																		(uint16_t)574
#define DCU_CURRENT_CSV_INDEX 																(uint16_t)577
#define XBEE_CURRENT_CSV_INDEX 																(uint16_t)582
#define DUC_3V3_CURRENT_CSV_INDEX 														(uint16_t)586
#define DCU_12V_VOLTAGE_CSV_INDEX 														(uint16_t)590
#define DCU_5V_VOLTAGE_CSV_INDEX 															(uint16_t)596
#define DCU_3V3_VOLTAGE_CSV_INDEX 														(uint16_t)601
#define DATRON_DISTANCE_CSV_INDEX 														(uint16_t)606
#define DATRON_X_CSV_INDEX 																		(uint16_t)618
#define DATRON_Y_CSV_INDEX 																		(uint16_t)626
#define DATRON_ANGLE_CSV_INDEX 																(uint16_t)634
#define END_CSV_INDEX 																				(uint16_t)642
