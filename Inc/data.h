...
#define BUFFER_BLOCK_LEN 																			(uint16_t)644
...
#define AUTOGEARSHIFT_FEEDBACK_CSV_INDEX 											(uint16_t)503
#define ACCELERATION_FEEDBACK_CSV_INDEX	 											(uint16_t)505
#define LAP_FLAG_CSV_INDEX																		(uint16_t)507
#define DAU_FR_TEMP_CSV_INDEX 																(uint16_t)509
#define DAU_FR_CURRENT_CSV_INDEX 															(uint16_t)512
#define DAU_FL_TEMP_CSV_INDEX 																(uint16_t)516
#define DAU_FL_CURRENT_CSV_INDEX 															(uint16_t)519
#define DAU_REAR_TEMP_CSV_INDEX 															(uint16_t)523
#define DAU_REAR_CURRENT_CSV_INDEX 														(uint16_t)526
#define SW_TEMP_CSV_INDEX 																		(uint16_t)530
#define SW_CURRENT_CSV_INDEX 																	(uint16_t)533
#define GCU_TEMP_CSV_INDEX 																		(uint16_t)538
#define GCU_CURR_CSV_INDEX 																		(uint16_t)541
#define H2O_PUMP_CURRENT_CSV_INDEX 														(uint16_t)545
#define FUEL_PUMP_CURRENT_CSV_INDEX 													(uint16_t)550
#define GEARMOTOR_CURRENT_CSV_INDEX 													(uint16_t)555
#define CLUTCH_CURRENT_CSV_INDEX 															(uint16_t)560
#define FAN_SX_CURRENT_CSV_INDEX 															(uint16_t)565
#define FAN_DX_CURRENT_CSV_INDEX 															(uint16_t)570
#define DCU_TEMP_CSV_INDEX 																		(uint16_t)575
#define DCU_CURRENT_CSV_INDEX 																(uint16_t)578
#define XBEE_CURRENT_CSV_INDEX 																(uint16_t)583
#define DUC_3V3_CURRENT_CSV_INDEX 														(uint16_t)587
#define DCU_12V_VOLTAGE_CSV_INDEX 														(uint16_t)591
#define DCU_5V_VOLTAGE_CSV_INDEX 															(uint16_t)597
#define DCU_3V3_VOLTAGE_CSV_INDEX 														(uint16_t)602
#define DATRON_DISTANCE_CSV_INDEX 														(uint16_t)607
#define DATRON_X_CSV_INDEX 																		(uint16_t)619
#define DATRON_Y_CSV_INDEX 																		(uint16_t)627
#define DATRON_ANGLE_CSV_INDEX 																(uint16_t)635
#define END_CSV_INDEX 																				(uint16_t)643
