...
void BNO085_init(void){
	...
	myIMU = BNO085_CreateIMU(&hi2c4, BNO085_ADDRESS, GPIOC, RESET_IMU_Pin, NULL, NULL); /*last fields are NULL because nboot pin is not connected*/
	uint8_t BNO085 = BNO085_IsAlive(&myIMU);
